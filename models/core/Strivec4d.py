...
class Space_vec(StrivecBase_hier):
    ...
    def compute_outputs(self, rays_chunk, time_emb=None, white_bg=True, is_train=False, ray_type=0, N_samples=-1, return_depth=0,
       ...
       # get the feactures, the connection between this space plane to the mlp or any shading module...
        ...
        import time
        t0 = time.time()  
        print("density shift:", self.density_shift)
        ...
        # calculate the querying time 

        rgb = self.renderModule(None, self.viewdirs[ray_id], app_features)
        rgb_map = segment_coo(
        ...
        return rgb_map, depth_map, rgb, ray_id, weights, t1-t0 # rgb, sigma, alpha, weight, bg_weight